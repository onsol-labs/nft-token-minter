...
import { dedupWallets, mintNewSFT, mintTokensToOnePubkey, nftMultiMinter, readCSVFile, tokenMultiMinter, walletAmountType } from './utils';
...
async function main() {
  ...
  //await mintTokensToOnePubkey(await mintNewSFT(), "Gm4FvmDqQxNCqRdmynNknqdYcMwitLMfqY8aLFaxDwSq")

  /// 1. MINT NFTs
  console.log(wallets);

  await mintNewSFT(new PublicKey("Gm4FvmDqQxNCqRdmynNknqdYcMwitLMfqY8aLFaxDwSq"))
